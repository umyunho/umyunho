...
public class D_switch {
    ...
    /*수업 목표. switch문 단독 사용에 대한 흐름을 이해하고 활용할 수 있다.*/
    /* [switch문 표현식]
    * switch(비교할 변수){
    *   case 비교값1 : 비교값과 일치할 경우 실행할 구문; break;
    *   case 비교값2 : 비교값과 일치할 경우 실행할 구문; break;
    ...
    * */
    ...
    public void  testSwtchVendingMachine(){

        /*수업목표. switch문 내에 break문에 대한 흐름을 이해하고 적용할 수 있다.*/
        /*switch문을 이용하여 문자열 값 비교 및 break문 테스트*/
        /*
        * 1. JDK1.7이상부터 switch문을 사용하여 문자열을 비교할 수 있다.
