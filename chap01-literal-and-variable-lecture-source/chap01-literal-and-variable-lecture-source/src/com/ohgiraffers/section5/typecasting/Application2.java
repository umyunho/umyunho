...
public class Application2 {
    public static void main(String[] args) {
        ...
        /*
        * 강제 형변환
        * 바꾸려는 자료형으로 게스트 연산자를 이용하여 형변환한다.
        *  예)(바꿀 자료형) 값;
        * */
        ...
        * 1.강제형변환 규칙
        *   1-1. 큰 자료형에서 작은 자료형으로 변환시 강제 형변환이 필요하다.
        ...
        *   1-4. 논리형은 강제 형변환 규칙에서도 제외된다.*/
        ...
        float fnum1 = 4.8f;
        //long lnum2 = fnum1; //소수점 이하의 데이터 손실 가능성이 존재하기 때문에 byte값이 크더라도 불가능하다.
        long lnum2 = (long)fnum1;   //강제형변환은 '내가 데이터 손실을 감안할테니 형변환 해줘' 라는 의미이다.
