...
public class Application {
    public static void main(String[] args) {
         ...
         * 정적 초기화 블럭으로 구분된다.
         * 1. 인스턴스 초기화 블럭
         *   1-1 인스턴스가 생성되는 시점에 생성자 호출 이전에 먼저 실행이된다.
         *       인스턴스가 호출하는 시점마다 호출이돤다.
         *       인스턴스 변수를 초기화하여 정적필드에는 실행시마다 값을 덮어준다.
         * {
         *   초기화 내용 작성
         * }
         * 2.정적 초기화 블럭
         *   2-1 클래스가 로드될 때 한번 동작한다.
