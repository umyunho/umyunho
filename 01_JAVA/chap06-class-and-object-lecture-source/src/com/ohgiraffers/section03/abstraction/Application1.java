...
public class Application1 {
    public static void main(String[] args) {
        /*수업 목표. 객체지향 프로그래밍에 대해 이해하고 객체의 클래스를 설계하여 프로그래밍 할 수 있다.*/
        /*
         *  객체 지향 프로그래밍이란
        ...
        * 현실세계를 프로그램의 목적에 맞게 단순화하는 추상화라는 기법을 적용하게 됐다.
        * */
        ...
        * 4-1 카레이서 클래스
        *   속성: 자동차
        *   행위(메소드): 시동을 걸어라 엑셀을 밟아라 브레이크를 밟아라 시동을 꺼라
        * 4-2 자동차 클래스
        *   속성: 시동의 상태, 현재 시속
