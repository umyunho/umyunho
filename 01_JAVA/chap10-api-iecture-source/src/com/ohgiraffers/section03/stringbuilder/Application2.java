...
public class Application2 {
    public static void main(String[] args) {
        /* 수업 목표 StringBuilder의 자주 사용되는 메소드의 용법을 확인할 수 있다.*/

        StringBuilder sb1 = new StringBuilder();

        /* capcity() : 용량(현재 버퍼의 크기)를 정수형으로 반환한는 메소드 (문자 명령어 + 16 기본용량)*/
        ...
        * */
        ...
        System.out.println("sb2.delete(2,5) = " + sb2.delete(2,5)); //앞숫자 부터 뒷숫자 전까지 //jaracle
        ...
        System.out.println("sb2.insert() = " + sb2.insert(0,"j"));
