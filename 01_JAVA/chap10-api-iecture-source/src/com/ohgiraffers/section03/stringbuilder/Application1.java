...
public class Application1 {
    public static void main(String[] args) {
        /*수업 목표. String과 StringBuilder의 차이점을 이해하고 사용할 수 있다.*/
        /*
        * 두 클래스는 스레드 동기화 기능 제공 여부에 따라 차이점이 있다.
        * StringBuilder : 스레드 동기화 기능을 제공하지 않음
        *                 스레드 동기화처리를 고려하지 않은 상황에서 StringBuilder보다 성능이 좋음
        * StringBuffer : 스레드 동기화 기능 제공함
        *                성능면에서는 StringBuilder보다 느림
        *  두개의 차이는 스레드 동기화 유무이고, 현재 우리는 스레드를 고려하지 않기 떄문에 
        ...
        *           하지만 변하지 않는 문자열을 자주 읽어 들이는 경우에는 ㅇ오히려 좋은 겅능을 기대할 수 있다.
        ...
        * 즉, 동일한 값을 가지는 경우 같은 해쉬코드에 반환하는 것이 아닌 
