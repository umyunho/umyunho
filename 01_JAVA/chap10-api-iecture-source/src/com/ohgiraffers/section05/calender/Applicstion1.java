...
public class Applicstion1 {
    public static void main(String[] args) {
        ...
        /*2. Date(long date) 사용방법*/
        /*getTime() : 1970년 1월 1일 0시 0분 0초를 지난 시간을 millisecond로 계산해서 long타입으로 변환한다.*/

        System.out.println("today.getTime() = " + today.getTime()); //1712127121751\
        Date time = new Date(1712127121751L);
