...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("lastInedexOf('a')" + indexOf.lastIndexOf('a'));     //7
        System.out.println("lastInedexOf('z')" + indexOf.lastIndexOf('z'));     //-1

        System.out.println("===============================================");

        /*trim() : 문자열의 앞 뒤에 공백을 제거한 문자열을 반환한다.*/
        String trimStr = "   java   "; //앞뒤로 공백 3칸

        System.out.println("trimStr = " + trimStr + "#");
        System.out.println("trim() = " + trimStr.trim() + "#");
        System.out.println("trimStr = " + trimStr + "#");       //원본에는 영향을 주지않음
        ...
        * */
        ...
        /*isEmpty() : 문자열의 길이가 0이면 true를 아니면 false를 반환함*/
        System.out.println("isEmpty() : "+"".isEmpty() );
        System.out.println("isEmpty() : "+"   ".isEmpty() );

        /*길이가 0인 문자열과 null은 다르다.*/
        String str6 = null;
        String str7 = "";
