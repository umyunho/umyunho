...
public class Application3 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * 깊은 복시를 하는 방법은 4가지가 있다.
        *  1.for문을 이용한 동일한 인덱스 값 복사
        *  2.object의 clone()를 이용한 복사
        *  3.System의 arraycopy()를 이용한 복사
        *  4.Array의 copyOf()를 이용한 복사
        *   이중 가장 높은 성능을 보이는 것은 순수 배열의 복사를 위해 만들어진 arrycopy()메소드이며
        * 가장 많이 사용되는 방식은 좀 더 유연한 방식인 copyOf() 메소드이다.
        * clone()메소드는 이전 배열과 같은 배열밖에 만들 수 없다는 특징을 가지고
        * 그 외 3가지 방법은 복사하는 배열의 길이를 마음대로 조정할 수 있다.
        * */

        int[] originArr = new int[]{1,2,3,4,5};     //284720968
        ...
        * */
        ...
        /*4.Array의 copyOf()를 이용한 복사*/
        int[] copyAarr4 = Arrays.copyOf(originArr,7);
