...
public interface InterProduct extends java.io.Serializable/*, java.util.Comparator*/{
    /*
    * 인터페이스가 인터페이스를 상속 받을 시에는 extends 키워드를 사용하여
    ...
    * 반드시 접근제한자를 public로 해야 오버라이딩이 가능하다.
    * */

    void absMethod();

    /* 하지만, static메소드는 작성이 가능하다. (JDK 1.8에 추가된 기능) */
    ...
    public default void defaultMethod(){
        System.out.println("InterProduct클래스의 defaultMethod 호출함...");
    }
    //InterProduct interProduct = new InterProduct(); //에러
