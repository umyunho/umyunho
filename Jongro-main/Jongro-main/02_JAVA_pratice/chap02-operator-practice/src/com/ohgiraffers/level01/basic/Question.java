...
public class Question {
    ...
    public static void main(String[] args) {
		...
		*/
        ...
        int y = 5;
        char c = 'A'; // 'A'의 문자코드는 65
        System.out.println(y >= 5 || x < 0 && x > 2); // 우선 순위에 의해서 뒤의 x < 0 && x > 2를 먼저 계산하여 false가 나오고 그것을 토대로 y >= 5 와 || 연산을하면  y >=는 참이므로 true가 반환된다.
        ...
        System.out.println('5'-'0'); //char은 문자를 받는 자료형이나 문자는 아스키코드로 대입이 가능하므로 숫자 또한 대입이 가능하다. 따라서 값은 5
